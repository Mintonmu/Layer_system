	...
	<form id="form1" name="form1" action="" method="post">
		...
		<center>
			<table class="mobile" style="width: 95%;">
				...
				<tr height="25">
					<td class="outDetail" style="width: 30%">律师： <label
						style="font-weight: bold; color: red"> </label></td>
					<td class="outDetail2"><select id="userId" name="userId">
							<c:forEach items="${userList }" var="lists">
								<option value="${lists.id }" ${map.userId==lists.id?'selected':'' }>${lists.name
									}</option>
							</c:forEach>
					</select></td>
				</tr>
				<tr height="25">
					<td class="outDetail" style="width: 30%">历史案件名称： <label
						style="font-weight: bold; color: red"> </label></td>
