						...
						<div class="content">
							<ul>
								<c:forEach items="${list }" var="listss">
									<li><a href="wdxxShow.html?id=${listss.id }">${listss.customerName }:${listss.title },日期：<fmt:formatDate value="${listss.insertDate}" type="date" pattern="yyyy-MM-dd HH:mm:ss"/>,[赞：${listss.zan }]</a>
