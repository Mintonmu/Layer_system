			...
			<div class="row">
				...
				<div class="col-md-6" style="margin-bottom: 30px;">
					<form name="form1" id="registerFormcustomer" method="post" action="contact.php">
						...
						<div class="form-group">
							<input type="text" class="form-control" id="phone"  name="phone" placeholder="标题">
						</div>
						<div class="form-group">
				...
				<div class="col-md-6">
					<p><span class="glyphicon glyphicon-home"></span> 我们：法律咨询管理系统</p>
