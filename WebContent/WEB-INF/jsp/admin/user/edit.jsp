	...
	<form id="form1" name="form1" action="" method="post">
		...
		<center>
			<table class="mobile" style="width: 95%;">
				...
				<tr height="25">
					<td class="outDetail" style="width: 30%">擅长领域： <label
						style="font-weight: bold; color: red"> </label></td>
					<td class="outDetail2"><textarea rows="5" id="gh"
							cols="50" name="gh">${map.gh }</textarea></td>
				</tr>
				<tr height="25">
				...
				<tr height="25">
					...
					<td class="outDetail2"><input id="f_fileImg0" name="cmfile"
						...
						value="${map.headPic }"> <c:if test="${map.headPic!=null }">
